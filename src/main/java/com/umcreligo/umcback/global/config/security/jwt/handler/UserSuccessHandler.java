...
import com.umcreligo.umcback.domain.user.dto.WithDrawDto;
...
public class UserSuccessHandler implements AuthenticationSuccessHandler {
    ...
    public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response, Authentication authentication) throws IOException, ServletException {
        ...
        if(user.getStatus().equals(User.UserStatus.ACTIVE)){
            ...
            String message = "탈퇴된 회원 입니다.";
            WithDrawDto withDrawDto = new WithDrawDto(message);
            new ObjectMapper().writeValue(response.getWriter(), new BaseResponse(withDrawDto));
        }
    }
}
